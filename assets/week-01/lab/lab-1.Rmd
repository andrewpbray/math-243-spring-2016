...
Go ahead and sign on to the Reed RStudio Server at https://rstudio-dev.reed.edu. (You
will be using the same login that you use at https://mail.reed.edu here.) You
should see a window that looks similar to the image shown below after logging in.

<center>
<img src="more/reed_rstudio_server_2016-01.png" width=800>
</center>
...
providing a template for you. Follow the steps below to get this template set up:

- Go to File -> New File -> R Markdown.
- Click on **From Template**.
- Select "R Markdown Lab Report".  Enter `lab1` under **Name:**.  The **Location:** 
is set by default to your home directory `~`.  Click the **OK** button.

<center>
<img src="more/template_dialog.png" width=400>
</center>
...
-   In what year did we see the most total number of births in the U.S.? *Hint:*
    ...
    in a descending order with another function: `descr` (for descending order).
