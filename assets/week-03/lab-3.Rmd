...
transformations, polynomials, and interaction terms. Forward selection will
likely be your most useful strategy, but you may also want to consider adjusted
R-squared and RSE.


#### 4. Model diagnostics

If you're relying on p-values to decide which variable to include in your model,
you'll want to verify that they're accurate. Bring up residual plots for your
models and assess the validity of your model (normal residuals with
